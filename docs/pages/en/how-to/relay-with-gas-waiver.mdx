...
- A governance-registered waiver key. The Enterprise SDK runs on Stable Mainnet and Stable Testnet, and access is gated: [contact Stable](https://discord.gg/stablexyz) to get a whitelisted waiver key.
...
- [**Enable gas-free transactions**](/en/how-to/integrate-gas-waiver): Use Stable's hosted Waiver Server instead of registering your own waiver.
