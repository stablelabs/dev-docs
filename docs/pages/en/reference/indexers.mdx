...
Chainalysis supports Stable in [KYT](https://www.chainalysis.com/product/kyt/), its entity screening products, and [Reactor](https://www.chainalysis.com/product/reactor/).

Its [Stable integration announcement](https://www.chainalysis.com/blog/stable-automatic-token-support/) confirms automatic coverage for new tokens. This includes tokens that follow major standards such as ERC-20 and ERC-721.
