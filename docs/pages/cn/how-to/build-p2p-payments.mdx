...
无需中间件,无需中介。如需了解概念性概述,请参阅 [P2P 支付](/en/reference/p2p-payments)。如果想跳过 ABI 相关工作、用几行代码实现可用的 `transfer`,请使用 [Stable SDK](/en/explanation/sdk-overview)。
...
- Node.js 20 或更高版本。
- 一个拥有测试网 USDT0 的私钥(参见[快速开始](/en/tutorial/quick-start)为钱包注资)。
...
- [**订阅与收款**](/en/how-to/subscribe-and-collect) — 基于拉取的周期性订阅,使用 EIP-7702 委托。
- [**使用发票付款**](/en/how-to/pay-with-invoice) — 使用 ERC-3009 和确定性 nonce 结算发票。
- [**发送你的第一笔 USDT0**](/en/tutorial/send-usdt0) — 参考基本的原生转账与 ERC-20 转账流程。
