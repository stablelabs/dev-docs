...
:::note
**개념:** x402 프로토콜과 Stable에 적합한 이유는 [x402](/en/explanation/x402)를 참고하세요. 상위 수준의 사용 사례 모델은 [유료 호출 API](/en/reference/pay-per-call)를 참고하세요.
:::
...
- [**x402 개념**](/en/explanation/x402) — 프로토콜과 그것이 적용되는 위치를 이해하세요.
- [**ERC-3009**](/en/explanation/erc-3009) — x402가 사용하는 정산 표준을 검토하세요.
- [**MCP 서버로 결제하기**](/en/how-to/pay-with-mcp) — AI 클라이언트가 프롬프트를 통해 호출할 수 있도록 이 API를 MCP 도구로 래핑하세요.
