...
:::note
**概念：** 关于系统交易如何将 SDK 层事件桥接到 EVM 以及其重要性，请参阅 [系统交易](/en/explanation/system-transactions)。
:::

## 前置条件

- 了解 [系统交易](/en/explanation/system-transactions)。
- 熟悉 [质押](/en/explanation/staking-module)，特别是 `undelegate` 和解绑流程。
...
- [**系统交易概念**](/en/explanation/system-transactions) — 了解协议层事件如何到达 EVM。
- [**质押模块概念**](/en/explanation/staking-module) — 回顾委托和解绑流程。
- [**质押预编译参考**](/en/reference/staking-module-api) — 查找触发此处所追踪事件的方法。
