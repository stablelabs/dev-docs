 ...
 *  - `product: 'docs'` is registered as a super property, matching the Stable
 *    PostHog schema so every docs event can be filtered from other products.
...
posthog.register({product:'${POSTHOG_PRODUCT}'});
