...
:::tip
`@stablechain/enterprise` does everything below in one call against the same governance-registered waiver. If you're writing TypeScript, use [Relay with gas waiver](/en/how-to/relay-with-gas-waiver) instead of building wrapper transactions by hand.
:::
