...
* Team and Investors & advisors allocations follow a one-year cliff followed by linear vesting, to ensure long-term commitment.
...
* Designed to ensure long-term alignment between the team and the Stable ecosystem.
    ...
    **Vesting schedule**
    * **1-year cliff:** No tokens are unlocked in the first 24 months
...
The team allocation uses a one-year cliff followed by linear vesting, ensuring long-term alignment and continued contributions toward network development.
