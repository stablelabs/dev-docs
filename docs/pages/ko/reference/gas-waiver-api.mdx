...
:::note
**개념:** 가스 면제가 무엇이며 왜 존재하는지에 대해서는 [가스 면제](/en/explanation/gas-waiver)를 참조하세요. 호스팅된 Waiver Server를 대상으로 한 통합 방법 가이드는 [가스 무료 트랜잭션 활성화](/en/how-to/integrate-gas-waiver)를 참조하세요.
:::
...
- [**제로 가스 트랜잭션**](/en/how-to/zero-gas-transactions) — 가스 수수료가 0임을 보여주는 영수증과 함께하는 데모 중심 안내.
- [**가스 무료 트랜잭션 활성화**](/en/how-to/integrate-gas-waiver) — 배치 제출 및 오류 처리를 포함한 전체 호스팅 API 통합 가이드.
- [**자체 호스팅 가스 면제**](/en/how-to/self-hosted-gas-waiver) — 호스팅 API 없이 자체 waiver 인프라를 실행합니다.
