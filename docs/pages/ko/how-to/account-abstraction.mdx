...
:::note
**개념:** EIP-7702가 Stable에서 무엇을 가능하게 하는지와 보안 고려 사항에 대해서는 [EIP-7702](/en/explanation/eip-7702)를 참조하세요.
:::
...
- [**구독 및 수금**](/en/how-to/subscribe-and-collect) — SubscriptionManager를 사용하여 반복 구독 결제에 EIP-7702를 적용합니다.
- [**EIP-7702 개념**](/en/explanation/eip-7702) — 배포하기 전에 위임 모델을 이해하세요.
- [**EIP-7702 레퍼런스**](/en/reference/eip-7702-api) — `0x04` 트랜잭션 형식과 권한 부여 필드를 찾아보세요.
