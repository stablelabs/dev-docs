...
:::note
**概念：** 有关 x402 协议及其为何适用于 Stable，请参阅 [x402](/zh-CN/explanation/x402)。有关高级用例模型，请参阅 [按次计费 API](/zh-CN/reference/pay-per-call)。
:::
...
- [**x402 概念**](/zh-CN/explanation/x402)：了解协议及其适用范围。
- [**ERC-3009**](/zh-CN/explanation/erc-3009)：回顾 x402 使用的结算标准。
- [**使用 MCP 服务器支付**](/zh-CN/how-to/pay-with-mcp)：将此 API 封装为 MCP 工具，以便 AI 客户端可以通过提示调用它。
