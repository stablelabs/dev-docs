...
:::note
**概念：** 关于 EIP-7702 在 Stable 上能够实现的功能以及安全注意事项，请参阅 [EIP-7702](/en/explanation/eip-7702)。
:::
...
- [**订阅与收款**](/en/how-to/subscribe-and-collect) — 使用 SubscriptionManager 将 EIP-7702 应用于周期性订阅支付。
- [**EIP-7702 概念**](/en/explanation/eip-7702) — 在上线之前理解委托模型。
- [**EIP-7702 参考**](/en/reference/eip-7702-api) — 查阅 `0x04` 交易格式和授权字段。
