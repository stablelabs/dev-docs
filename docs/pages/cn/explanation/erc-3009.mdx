...
这是 Stable 上 [x402](/en/explanation/x402) 支付背后的结算机制。
...
正是这一特性使 Stable 上的 ERC-3009 成为更高层支付协议的坚实基础。[x402](/en/explanation/x402) 直接利用了这一点，在标准 HTTP 通信中将 ERC-3009 用作其链上结算机制。
...
- [USDT 作为 Gas](/en/explanation/usdt-as-gas-token)
- [USDT0 在 Stable 上的行为](/en/explanation/usdt0-behavior)
