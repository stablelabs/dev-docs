...
- [**资金流转**](/en/explanation/flow-of-funds) — 查看 USDT 从入金到结算的端到端生命周期。
- [**桥接教程**](/en/tutorial/bridge-usdt0) — 使用 LayerZero OFT Adapter 将测试 USDT 从 Sepolia 桥接到 Stable 测试网。
- [**USDT 作为 gas**](/en/explanation/usdt-as-gas-token) — 了解该资产到达 Stable 后的作用。
