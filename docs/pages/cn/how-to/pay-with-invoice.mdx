...
- [**发票结算概念**](/zh-CN/reference/invoices)：了解确定性随机数对账模型。
- [**ERC-3009**](/zh-CN/explanation/erc-3009)：回顾此流程背后的签名授权标准。
- [**启用免 Gas 交易**](/zh-CN/how-to/integrate-gas-waiver)：结合 Gas Waiver 以消除结算路径中的 Gas。
