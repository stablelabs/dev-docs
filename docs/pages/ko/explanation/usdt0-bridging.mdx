...
- [**자금 흐름**](/en/explanation/flow-of-funds) — 온램프부터 정산까지 USDT의 전체 라이프사이클을 확인하세요.
- [**브리지 튜토리얼**](/en/tutorial/bridge-usdt0) — LayerZero OFT 어댑터를 사용하여 Sepolia에서 Stable 테스트넷으로 Test USDT를 브리징하세요.
- [**가스로서의 USDT**](/en/explanation/usdt-as-gas-token) — 자산이 Stable에 도달한 후 무엇을 하는지 이해하세요.
