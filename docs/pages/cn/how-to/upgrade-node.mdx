...
> 有关完整的版本历史和升级详情，请参阅[版本历史](/en/reference/testnet-version-history)。
...
- [版本历史](/en/reference/testnet-version-history) - 完整的升级历史和发布说明
- 升级后[监控你的节点](/en/how-to/monitor-node)
- 查阅[故障排查](/en/how-to/troubleshoot-node)了解常见问题
