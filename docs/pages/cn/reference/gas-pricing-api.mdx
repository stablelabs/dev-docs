...
:::note
**概念：** 关于 Stable 为何使用单组件费用模型以及它与 Ethereum 的对比，请参阅 [Gas 定价](/en/explanation/gas-pricing)。
:::
...
- [**Gas 定价概念**](/en/explanation/gas-pricing) — 理解 Stable 为何使用单组件费用模型。
- [**Ethereum 对比**](/en/explanation/ethereum-comparison) — 了解从 Ethereum 移植时会遇到的所有行为差异。
- [**JSON-RPC API**](/en/reference/json-rpc-api) — 参考 Stable 提供的 `eth_*` 方法。
