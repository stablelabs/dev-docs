...
| Coinbase Developer Platform (CDP)                                                                                                                                                                                                                     | Embedded / In-App Wallet Infra            | Non-custodial; keys secured in a trusted execution environment                                                             | [https://docs.cdp.coinbase.com/wallets/non-custodial-wallets/overview](https://docs.cdp.coinbase.com/wallets/non-custodial-wallets/overview)                                               | Wallet API supports Stable as an EVM network; Coinbase Onramp does not support Stable       |
...
| [Privy](https://www.privy.io/)                                                                                                                                                                                                                       | Embedded / In-App Wallet Infra            | Secure enclaves (TEEs) with key splitting                                                                                  | [https://docs.privy.io/wallets/overview/embedded](https://docs.privy.io/wallets/overview/embedded)                                                                                           | Embedded wallets with configurable custody, authentication, and policy controls            |
| [Portal](https://www.portalhq.io/)                                                                                                                                                                                                                    | Embedded / In-App Wallet Infra            | MPC key shares                                                                                                             | [https://docs.portalhq.io/sdks/quickstart](https://docs.portalhq.io/sdks/quickstart)                                                                                                         | Embedded EVM wallets with mobile, web, and API integrations                                 |
| [Turnkey](https://www.turnkey.com/)                                                                                                                                                                                                                  | Embedded / In-App Wallet Infra            | Trusted execution environments (TEEs)                                                                                      | [https://docs.turnkey.com/solutions/embedded-wallets/overview](https://docs.turnkey.com/solutions/embedded-wallets/overview)                                                                 | Embedded wallets with configurable custody and programmable signing policies               |
...
| [Safe](https://safe.global/) | Smart Wallets & Account Abstraction Infra | Smart contract account with m-of-n multisig, optional passkey owners | [https://docs.safe.global](https://docs.safe.global) | Safe\{Wallet\} and the Safe\{Core\} SDK support Stable; contract versions 1.3.0, 1.4.1, and 1.5.0 are deployed, plus the passkey and ERC-4337 modules |
...
**Get started**: Follow the [CDP non-custodial wallet documentation](https://docs.cdp.coinbase.com/wallets/non-custodial-wallets/overview) and choose the user-auth or API-key quickstart.
...
**Get started**: Follow the [Privy embedded wallet docs](https://docs.privy.io/wallets/overview/embedded) to create a wallet, then configure Stable as an EVM network in your app.
...
**Get started**: Follow the [Portal SDK quickstart](https://docs.portalhq.io/sdks/quickstart), then map Stable's CAIP-2 chain ID (`eip155:988`) to `https://rpc.stable.xyz` in `rpcConfig`.
...
**Get started**: Follow the [Turnkey embedded wallet overview](https://docs.turnkey.com/solutions/embedded-wallets/overview), choose an SDK, and configure Stable as an EVM network.
...
| [**Safe**](https://safe.global/)            | Smart Account (multisig + AA)         | m-of-n owner signatures, passkeys, modules and guards | [https://docs.safe.global](https://docs.safe.global)                                   | Treasury and shared-custody accounts; batched transactions, passkey owners, ERC-4337 via Safe4337Module |
...
| Daimo P-256 verifier        | `0xc2b78104907F722DABAc4C69f826a522B2754De4` |

**Get started**: Create an account in [Safe\{Wallet\}](https://app.safe.global) and select Stable as the network, or use the [Safe\{Core\} Protocol Kit](https://docs.safe.global/sdk/protocol-kit) with `https://rpc.stable.xyz` to deploy and operate a Safe from your own application.
