...
미들웨어도 중개자도 없습니다. 개념적 개요는 [P2P 결제](/en/reference/p2p-payments)를 참고하세요. ABI 작업을 건너뛰고 몇 줄로 작동하는 `transfer`에 도달하려면 [Stable SDK](/en/explanation/sdk-overview)를 사용하세요.
...
- Node.js 20 이상.
- 테스트넷 USDT0가 있는 개인 키 (지갑에 자금을 충전하려면 [빠른 시작](/en/tutorial/quick-start) 참고).
...
- [**구독 및 수금**](/en/how-to/subscribe-and-collect) — EIP-7702 위임을 사용한 풀 기반 정기 구독.
- [**인보이스로 결제하기**](/en/how-to/pay-with-invoice) — ERC-3009와 결정론적 nonce로 인보이스를 정산합니다.
- [**첫 USDT0 보내기**](/en/tutorial/send-usdt0) — 기본적인 네이티브 vs. ERC-20 전송 흐름을 참고하세요.
