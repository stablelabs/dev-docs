...
这是 Stable 上 [x402](/zh-CN/explanation/x402) 支付的结算机制。
...
这一特性使得 Stable 上的 ERC-3009 成为更高级别支付协议的坚实基础。[x402](/zh-CN/explanation/x402) 直接利用了这一点，使用 ERC-3009 作为其在标准 HTTP 通信中的链上结算机制。
...
- [USDT 作为 Gas](/zh-CN/explanation/usdt-as-gas-token)
- [USDT0 在 Stable 上的行为](/zh-CN/explanation/usdt0-behavior)
- [x402 (HTTP 原生支付)](/zh-CN/explanation/x402)
