...
Cosmovisor can switch binaries when the on-chain upgrade handler reaches its configured height. Follow the [Cosmovisor documentation](https://docs.cosmos.network/sdk/v0.53/build/tooling/cosmovisor) and use the upgrade name from the applicable governance proposal.
