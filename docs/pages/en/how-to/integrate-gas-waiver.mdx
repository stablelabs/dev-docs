...
This guide covers the hosted Waiver Server API, where Stable operates the waiver and you authenticate with an API key. To register your own waiver address through governance instead, see [Choosing an integration path](/en/explanation/gas-waiver#choosing-an-integration-path).
...
- [**Relay with gas waiver**](/en/how-to/relay-with-gas-waiver): Sponsor gas from your own governance-registered waiver with the Enterprise SDK.
