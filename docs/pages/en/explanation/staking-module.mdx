...
description: "Understand how EVM contracts delegate, undelegate, and manage validators through Stable's staking precompile."
...
- A restaking or liquid-staking product tracks unbonding completions: subscribe to the `UnbondingCompleted` event with [Tracking unbonding completions](/en/how-to/track-unbonding).
