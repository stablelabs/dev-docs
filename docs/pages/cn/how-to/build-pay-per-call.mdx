...
:::note
**概念：** 关于 x402 协议及其为何适合 Stable，请参阅 [x402](/en/explanation/x402)。关于高层用例模型，请参阅 [按调用付费 API](/en/reference/pay-per-call)。
:::
...
- [**x402 概念**](/en/explanation/x402) — 了解协议及其适用场景。
- [**ERC-3009**](/en/explanation/erc-3009) — 回顾 x402 使用的结算标准。
- [**通过 MCP 服务器付费**](/en/how-to/pay-with-mcp) — 将此 API 封装为 MCP 工具，以便 AI 客户端可以通过提示词调用它。
