...
> 전체 버전 기록 및 업그레이드 세부 사항은 [버전 기록](/en/reference/testnet-version-history)을 참조하세요.
...
- [버전 기록](/en/reference/testnet-version-history) - 전체 업그레이드 기록 및 릴리스 노트
- 업그레이드 후 [노드 모니터링](/en/how-to/monitor-node)
- 일반적인 문제는 [문제 해결](/en/how-to/troubleshoot-node)을 검토하세요
